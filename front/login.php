...
<html>
	...
	<div class="wiki-inner">
		...
		<?php
			...
			{
				echo "<br>";
				echo "<form align='center' action='../google/google2.php'><button><img src='googleIcon.png' width=100px height=100px></button></form>";
				echo "<br>";
				echo "<form align='center' action='../facebook/FBlogin.php'><button><img src='facebookIcon.png' width=100px height=100px></button></form>";
			}
